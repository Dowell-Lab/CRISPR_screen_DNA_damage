...
countfile = '/home/lsanford/crispr_screen/counts/fullbasal_grna1_coupled_counts.tsv'
outbase = '/home/lsanford/crispr_screen/finalout/fullbasal'

# countfile = '/path/to/coupled/countfile/fullbasal_grna1_coupled_counts.tsv'
...
sample_names_to_analyze = [
  'day0_rep1', 'day14_rep1', 'day0_rep2', 'day14_rep2',
] # Omit replicate 3
...
# Basal
# Read in files
allcount_df = read_file(countfile)
allcount_df.replace(np.nan, 0, inplace=True) # Replace any NaNs
allcount_df = allcount_df[sample_names_to_analyze]

#Run pipeline
guide_fold_changes = filter_fc_norm(allcount_df)
gene_phenotypes = phenotype_calc(guide_fold_changes)
significance_filtering(gene_phenotypes)
